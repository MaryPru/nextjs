const SecondIcon =()=> {
    return (
        <svg width="576" height="554" viewBox="0 0 576 554" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path opacity="0.07" d="M69.7346 279.912C69.7346 382.35 129.624 430.732 203.461 388.099C277.297 345.467 337.113 227.798 337.113 125.434C337.113 22.9967 277.223 -25.385 203.386 17.2476C129.55 59.8802 69.7346 177.475 69.7346 279.912Z" fill="url(#paint0_linear)"/>
            <path opacity="0.4" d="M264.171 64.5091C281.698 54.3549 299.076 49.1285 315.335 49.0539C331.519 48.9792 346.286 54.131 358.742 64.2105C371.197 74.29 381.042 88.9986 387.754 107.59C394.467 126.181 397.972 148.356 397.972 172.696L264.171 249.898V64.5091Z" fill="url(#paint1_linear)"/>
            <path opacity="0.2" d="M368.064 147.012C368.064 183.671 360.233 224.064 345.54 263.038C330.847 302.012 309.964 337.851 285.576 365.999C261.187 394.147 234.263 413.335 208.308 421.175C182.354 429.014 158.562 425.132 139.842 409.975C121.121 394.819 108.442 369.134 103.222 336.208C98.0755 303.207 100.686 264.382 110.829 224.661C120.972 184.941 138.052 146.041 160.054 112.965C182.055 79.8895 207.861 54.0561 234.338 38.8248V224.288L368.064 147.012Z" fill="url(#paint2_linear)"/>
            ...
            <path d="M576 45.0964V13.6632L492.244 62.1196V93.5527L576 45.0964Z" fill="url(#paint4_linear)"/>
            <path opacity="0.15" d="M387.456 123.418L436.083 95.3449V105.499L387.456 133.572V123.418Z" fill="white"/>
            <path opacity="0.15" d="M387.456 143.802L481.206 89.6708V99.825L387.456 153.956V143.802Z" fill="white"/>
            <path opacity="0.15" d="M387.456 164.11L501.045 98.4809V108.635L387.456 174.339V164.11Z" fill="white"/>
            ...
            <path opacity="0.3" d="M241.125 307.314L19.2424 435.585L19.1678 551.387L221.51 434.465L241.051 440.886L241.125 307.314Z" fill="url(#paint6_linear)"/>
            <path d="M83.7561 455.968V424.535L0 472.991V504.424L83.7561 455.968Z" fill="url(#paint7_linear)"/>
            <path opacity="0.15" d="M184.069 368.538L135.441 396.611V406.765L184.069 378.692V368.538Z" fill="white"/>
            <path opacity="0.15" d="M184.069 388.845L96.2856 439.542V449.696L184.069 398.999V388.845Z" fill="white"/>
            <path opacity="0.15" d="M184.069 409.229L70.4804 474.858V485.012L183.995 419.383L184.069 409.229Z" fill="white"/>
            ...
            <path d="M492.915 210.252C492.915 219.883 498.584 224.438 505.52 220.481C512.456 216.449 518.124 205.399 518.124 195.692C518.124 186.061 512.456 181.506 505.52 185.464C498.584 189.495 492.915 200.62 492.915 210.252Z" fill="url(#paint13_linear)"/>
            ...
            <defs>
                <linearGradient id="paint0_linear" x1="237.918" y1="-25.0121" x2="255.856" y2="351.288" gradientUnits="userSpaceOnUse">
                    <stop stop-color="#3F51B5"/>
                    <stop offset="1" stop-color="white" stop-opacity="0"/>
                </linearGradient>
                <linearGradient id="paint1_linear" x1="331.146" y1="-27.9987" x2="331.146" y2="203.457" gradientUnits="userSpaceOnUse">
                    <stop stop-color="#4179A7"/>
                    <stop offset="1" stop-color="#1A3144"/>
                </linearGradient>
                <linearGradient id="paint2_linear" x1="207.712" y1="49.2776" x2="195.135" y2="474.112" gradientUnits="userSpaceOnUse">
                    <stop stop-color="#4A85B6"/>
                    <stop offset="1" stop-color="#1A3144"/>
                </linearGradient>
                <linearGradient id="paint3_linear" x1="419.217" y1="7.08116" x2="412.264" y2="294.965" gradientUnits="userSpaceOnUse">
                    <stop stop-color="#4A85B6"/>
                    <stop offset="1" stop-color="#1A3144"/>
                </linearGradient>
                <linearGradient id="paint4_linear" x1="534.122" y1="13.6632" x2="534.122" y2="93.5527" gradientUnits="userSpaceOnUse">
                    <stop stop-color="#3F51B5"/>
